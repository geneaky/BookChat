...
public class BookSearchServiceTest {
    ...
    private BookSearchRequestDto getBookSearchRequestDto(String query, Integer size, Integer page, BookSearchSort bookSearchSort) {
    ...
    public void 외부api_호출시_sort지정() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto("이펙티브", 5, 1, BookSearchSort.LATEST);
