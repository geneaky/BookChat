...
class BookRepository {
    ...
    private lateinit var books :ArrayList<BookResponse>
    private lateinit var call : Call<ArrayList<BookResponse>>

    fun getBooks(searchKeyWord : String,searchOption: SearchOptionType,callback : (ArrayList<BookResponse>) -> Unit){
        ...
        if(App.instance.networkManager.checkNetworkState()){ //네트워크 연결 체크
            ...
            call.enqueue(object :Callback<ArrayList<BookResponse>>{
                override fun onResponse(
                    call: Call<ArrayList<BookResponse>>,
                    response: Response<ArrayList<BookResponse>>
                ) {
