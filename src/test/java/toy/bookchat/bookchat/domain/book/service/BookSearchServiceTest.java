...
class BookSearchServiceTest {
    ...
    private BookSearchRequestDto getBookSearchRequestDto(String query, Integer size, Integer page,
    ...
    void isbn으로_외부api_호출_json결과_응답() throws Exception {
        ...
        BookSearchResponseDto bookSearchResponseDto = bookSearchService.searchByQuery(
    ...
    void title로_외부api_호출_json결과_응답() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto(title, null, null,
            null);
    ...
    void author로_외부api_호출_json결과_응답() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto(authors[0], null, null,
            null);
    ...
    void 외부api_호출시_size지정() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto("이펙티브", 5, null, null);
    ...
    void 외부api_호출시_page지정() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto("이펙티브", 5, 1, null);
    ...
    void 외부api_호출시_sort지정() throws Exception {
        ...
        BookSearchRequestDto bookSearchRequestDto = getBookSearchRequestDto("이펙티브", 5, 1,
