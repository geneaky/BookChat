...
[cols="1,1"]
|===
|roomId|/enter/chatrooms/{roomId}
|Long   |/enter/chatrooms/123
|===

```stomp
    SEND
    Authorizaiton: Bearer [JWT Token]
    host: wss://bookchat.link/subscriptions/enter/chatrooms/[123]
...
[cols="1,1"]
|===
|roomId|/leave/chatrooms/{roomId}
|Long   |/leave/chatrooms/123
|===

```stomp
    SEND
    Authorizaiton: Bearer [JWT Token]
    host: wss://bookchat.link/subscriptions/leave/chatrooms/[123]
