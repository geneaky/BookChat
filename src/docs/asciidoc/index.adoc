...
include::{snippets}/get-chatroom-participants/request-headers.adoc[]

`Request`

include::{snippets}/get-chatroom-participants/path-parameters.adoc[]
include::{snippets}/get-chatroom-participants/http-request.adoc[]

`Response`

include::{snippets}/get-chatroom-participants/response-fields.adoc[]
include::{snippets}/get-chatroom-participants/http-response.adoc[]
