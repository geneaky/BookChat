...
include::{snippets}/get-chatroom-users/request-headers.adoc[]

`Request`

include::{snippets}/get-chatroom-users/path-parameters.adoc[]
include::{snippets}/get-chatroom-users/http-request.adoc[]

`Response`

include::{snippets}/get-chatroom-users/response-fields.adoc[]
include::{snippets}/get-chatroom-users/http-response.adoc[]
