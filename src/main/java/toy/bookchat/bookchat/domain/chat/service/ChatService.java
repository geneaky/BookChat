...
public class ChatService {
    ...
    public ChatService(ChatRepository chatRepository, ParticipantRepository participantRepository, MessagePublisher messagePublisher) {
    ...
    public void sendMessage(Long userId, Long roomId, String message) {
        ...
        messagePublisher.sendCommonMessage(participant.getChatRoomSid(), CommonMessage.from(participant.getUser(), chat));
    }

    @Transactional(readOnly = true)
    public ChatRoomChatsResponse getChatRoomChats(Long roomId, Long postCursorId, Pageable pageable, Long userId) {
        return new ChatRoomChatsResponse(chatRepository.getChatRoomChats(roomId, postCursorId, pageable, userId));
    }
}
