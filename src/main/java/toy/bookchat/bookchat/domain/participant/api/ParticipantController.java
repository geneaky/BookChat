...
public class ParticipantController {
    ...
    public void changeParticipantRights(@PathVariable Long roomId, @PathVariable Long userId, ParticipantStatus participantStatus, @UserPayload TokenPayload tokenPayload) {
    ...
    public void deleteParticipant(@PathVariable Long roomId, @PathVariable Long userId, @UserPayload TokenPayload tokenPayload) {
