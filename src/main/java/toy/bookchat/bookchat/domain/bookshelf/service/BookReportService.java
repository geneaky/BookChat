...
public class BookReportService {
    ...
    public BookReportService(BookShelfManager bookShelfManager, BookShelfReader bookShelfReader, BookReportAppender bookReportAppender, BookReportReader bookReportReader,
