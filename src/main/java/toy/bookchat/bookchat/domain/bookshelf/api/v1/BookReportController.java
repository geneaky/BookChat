...
public class BookReportController {
  ...
  @PostMapping
  public void writeBookReport(@Valid @RequestBody WriteBookReportRequest writeBookReportRequest,
  ...
  public void reviseBookReport(@PathVariable Long bookShelfId,
      @Valid @RequestBody ReviseBookReportRequest reviseBookReportRequest, @UserPayload TokenPayload tokenPayload) {
